...
export function SettingsMenu({
  ...
  return (
    ...
    >
      ...
      {isOpen && !disabled && (
        <div className="absolute right-0 top-full z-30 mt-3 w-[min(22rem,calc(100vw-2.5rem))] rounded-panel border border-fuchsia-400/30 bg-neutral-950/95 p-5 text-left shadow-[0_0_32px_rgba(217,70,239,0.2)] backdrop-blur-xl">
          ...
          <div className="mt-5 border-t border-neutral-800 pt-4">
            ...
            <div className="grid grid-cols-3 gap-1 rounded-control border border-neutral-800 bg-black p-1">
              {songModeOptions.map((option) => {
                ...
                return (
                  <button
                    className={`min-h-10 rounded-control px-2 py-2 text-xs font-bold transition-colors ${
                      isSelected
